...
    }
```
# 2 windows git bash 中 查询端口占用 并干掉
...
# 3 快速清空工作区 #clean #empty
`git checkout -- .;git clean -fd;`

# 4 mac干掉不要的文件 #find #\.DS_Store
...
# 13 服务器代码 #上传 | [[汇总所有在线文档#^ce3eb8|scp]]
...
# 23 weboeidp 172.19.20.119 hzj 账号
...
# 24 weboeidp 172.16.201.136 getConnectInfo 补丁 nwy admin1
...
# 25 tspace 服务，服务器修改服务名称，避免其自动重启
...
# 37 ssh-copy-id -i ~/.ssh/id_rsa.pub [zhangyao@172.16.103.196](mailto:zhangyao@172.16.103.196)
...
### 42.1.1 Vdi&[Voi@r00t](http://Voi@r00t)
...
# 44 [环境配置相关](siyuan://blocks/20230705103954-dsr1hc8 "环境配置相关-不常用")
