...
aliases:
  - 服务器命令集合
---
# 1 windows git bash 中 查询端口占用 并干掉
...
# 2 快速清空工作区 #clean #empty
`git checkout -- .;git clean -fd;`

# 3 mac干掉不要的文件 #find #\.DS_Store
...
# 12 服务器代码 #上传 | [[汇总所有在线文档#^ce3eb8|scp]]
...
# 22 weboeidp 172.19.20.119 hzj 账号
...
# 23 weboeidp 172.16.201.136 getConnectInfo 补丁 nwy admin1
...
# 24 tspace 服务，服务器修改服务名称，避免其自动重启
...
# 36 ssh-copy-id -i ~/.ssh/id_rsa.pub [zhangyao@172.16.103.196](mailto:zhangyao@172.16.103.196)
...
### 41.1.1 Vdi&[Voi@r00t](http://Voi@r00t)
...
# 43 [环境配置相关](siyuan://blocks/20230705103954-dsr1hc8 "环境配置相关-不常用")
